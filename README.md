...
**This plugin is actually not needed if you just want to simply turn on attribute swapping, you can do that in the paper.yml. This plugin is still usefull though because you can toggle it with a command and there is no required configuration.**
